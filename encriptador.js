var entradaTexto = document.querySelector(".entrada_texto");
var salidaTexto = document.querySelector(".salida_texto");
var seccionTitulo = document.querySelector(".resultado_titulo");  /* texto 1  */
var seccionTexto = document.querySelector(".resultado_texto");
var btnCopiar = document.querySelector(".boton_copiar");
...
function ocultar(){
    salidaTexto.style.background = "#a4855b";
...
function mostrar(){
    salidaTexto.style.background = "#FFF no-repeat center url(./assets/Muneco.png)" 
    salidaTexto.style = "#a4855b";
    seccionTitulo.style.display = "";
    seccionTexto.style.display = "";
